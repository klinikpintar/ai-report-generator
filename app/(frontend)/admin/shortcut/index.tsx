...
const Shortcut: React.FC<ShortcutProps> = ({ onShortcutClick }) => {
  return (
    <section className="container mx-auto max-w-screen-lg flex flex-col gap-y-8 py-8 pt-[130px] border-b-2 border-[#007399]">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-10">
        ...
        <div className="text-justify w-[350px]">
          <h1 className="text-2xl font-bold text-[#00B0EB]">
